            ...
            <div className='flex mf:flex-row flex-col items-start justify-start md:p-20 py-12 px-4'>
                <div className='flex flex-1 justify-start flex-col mf:mr-10'>
                    ...
                    {!currentAccount && <button
                        type="button"
                        className='flex flex-row justify-center items-center rounded-full my-5 p-3 bg-[#2952e3] cursor-pointer hover-bg:[#2546bd]'
                        onClick={connectWallet}>
                        <p className='text-white text- font-semibold'>Connect Wallet</p>
                    </button>}
